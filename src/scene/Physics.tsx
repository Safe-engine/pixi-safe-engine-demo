    ...
    return (
      <SceneComponent>
        ...
        <DragonBones $ref={this.dragon} node={{ x: 640, y: 1140 }} data={db_mecha_1004_d} animation="idle" playTimes={3} >
          <RigidBody type="static" friction={0.5} restitution={0.5}></RigidBody>
        ...
        <SpriteRender node={{ x: 40, y: 1230 }} spriteFrame={sf_button}>
          <RigidBody type="static"></RigidBody>
          <BoxColliderPhysics height={6} width={1200}></BoxColliderPhysics>
        </SpriteRender>
      </SceneComponent>
    )
  }
